...
<head>
    ...
    {{-- @notifyCss --}}
    <script src="{{ url('assets/sweetalert2/dist_sweetalert2/') }}/sweetalert2.min.js"></script>
    <link rel="stylesheet" href="{{ url('assets/sweetalert2/dist_sweetalert2/') }}/sweetalert2.min.css">
                    ...
                    <ul class="list-unstyled topnav-menu mb-0 d-flex align-items-center">
                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0" data-bs-toggle="dropdown" href="#"
                                ...
                                <span class="pro-user-name ms-1">{{ Auth::user()->email ?? 'User' }} <i class="mdi mdi-chevron-down"></i></span>
                            </a>
                ...
                <div id="sidebar-menu">
                    ...
                    <div class="logo-box">
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ url('/') }}/assets/images/logo_2.png" alt="" height="70">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ url('/') }}/assets/images/logo_2.png" alt="" height="70">
                            </span>
                    ...
                    @include('components.sidebar_anggota')
